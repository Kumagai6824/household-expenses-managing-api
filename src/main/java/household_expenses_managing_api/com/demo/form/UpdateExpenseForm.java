...
public class UpdateExpenseForm {
    ...
    public UpdateExpenseForm(int id, Expense.Type type, String category, int amount, LocalDate usedDate) {
        this.id = id;
        this.type = type;
    ...
    public Expense convertToExpenseEntity() {
        Expense expense = new Expense(this.id, this.type, this.category, this.amount, this.usedDate);
        return expense;
    }
}
